...
const MarketNav = () => {
  return (
    <div className='lg:flex items-center lg:px-[120px] lg:pt-[80px] justify-between'>
        ...
        <div className='shade lg:py-7 md:py-6 sm:py-5 py-4 flex items-center justify-between w-[90%] px-7 lg:mx-0 mx-auto'>
